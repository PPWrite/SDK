...
import cn.robotpen.demo.usb.PenInfo;
...
public class StartActivity2 extends Activity implements OnClickListener {
	...
	public static final String TAG = StartActivity2.class.getSimpleName();
...
//			Intent intent = new Intent(StartActivity2.this, ByUsbListActivity.class);
			...
			mHandler.postDelayed(new Runnable() {
				...
				public void run() {
					...
					if (Keys.APP_PEN_SERVICE_NAME.equals(svrName)) {
						startActivity(new Intent(StartActivity2.this, MainActivity.class));
					} else if (Keys.APP_USB_SERVICE_NAME.equals(svrName)) {
						Intent intent = new Intent(StartActivity2.this, PenInfo.class);
