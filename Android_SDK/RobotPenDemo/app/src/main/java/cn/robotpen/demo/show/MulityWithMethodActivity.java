...
public class MulityWithMethodActivity extends Activity
        implements
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.changePenBut: //更改笔粗细
                ...
                new AlertDialog.Builder(MulityWithMethodActivity.this).setTitle("修改笔粗细")
            ...
            case R.id.changePenColorBut:
                ...
                new AlertDialog.Builder(MulityWithMethodActivity.this).setTitle("修改笔颜色")
            ...
            case R.id.delPageBut:
                recordBoardView.delCurrPage();
                break;
            case R.id.gotoProBut:
                recordBoardView.frontPage();
                break;
            case R.id.gotoNextBut:
                recordBoardView.nextPage();
                break;
        }
    }
    ...
    public void checkDeviceConnStatus() {
        ...
        if (null == deviceEntity) {
            ...
            if (SmartPenService.TAG.equals(mPenManage.getSvrTag())) {
                //检查以前是否有连接过设备
                DeviceEntity lastDevice = PenManage.getLastDevice(MulityWithMethodActivity.this);
                if (lastDevice == null || TextUtils.isEmpty(lastDevice.getAddress())) {
                    AlertDialog.Builder alert = new AlertDialog.Builder(MulityWithMethodActivity.this);
                    alert.setTitle("提示");
                    ...
                    alert.setNegativeButton(R.string.confirm, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            dialog.dismiss();
                            Intent intent = new Intent(MulityWithMethodActivity.this, DeviceActivity.class);
                            MulityWithMethodActivity.this.startActivity(intent);
                            MulityWithMethodActivity.this.finish();
                        }
                    });
                    alert.show();
                } else {
    ...
    *扫描监听
    ...
    PenService.OnScanDeviceListener onScanDeviceListener = new PenService.OnScanDeviceListener() {
        ...
        public void find(DeviceEntity deviceObject) {
            DeviceEntity lastDevice = mPenManage.getLastDevice(MulityWithMethodActivity.this);
        ...
        public void complete(HashMap<String, DeviceEntity> hashMap) {
            if (!mPenManage.getIsStartConnect()) {
                Toast.makeText(MulityWithMethodActivity.this, "暂未发现设备", Toast.LENGTH_SHORT).show();
            }
        }
        ...
        public void status(int i) {
            switch (i) {
                case Keys.REQUEST_ENABLE_BT:
                    Toast.makeText(MulityWithMethodActivity.this, "蓝牙未打开", Toast.LENGTH_SHORT).show();
                ...
                case Keys.BT_ENABLE_ERROR:
                    Toast.makeText(MulityWithMethodActivity.this, "设备不支持BLE协议", Toast.LENGTH_SHORT).show();
                    break;
            }
    ...
    private PenService.OnConnectStateListener onConnectStateListener = new PenService.OnConnectStateListener() {
        ...
        public void stateChange(String arg0, ConnectState arg1) {
            if (arg1 == ConnectState.CONNECTED) {
                Toast.makeText(MulityWithMethodActivity.this, "设备已连接且连接成功！", Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(MulityWithMethodActivity.this, "设备已断开", Toast.LENGTH_SHORT).show();
            }
        }
    };
        ...
        switch (boardEvent) {
            ...
            case ERROR_DEVICE_TYPE:
                ...
                if (recordBoardView.getNoteEntity() != null
                    ...
                    Toast.makeText(MulityWithMethodActivity.this, "设备错误", Toast.LENGTH_LONG).show();
                }
                break;
