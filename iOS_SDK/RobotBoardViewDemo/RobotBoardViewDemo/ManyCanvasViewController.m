...
@interface ManyCanvasViewController ()<WhiteBoardViewDelegate,RobotPenDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate>
{
    BOOL isRecord;
...
@implementation ManyCanvasViewController
...
-(void)GetVideoTime:(float)Seconds{
    ...
    _videoTime = [NSString stringWithFormat:@"%@",[self getMMSSFromSS:[NSString stringWithFormat:@"%f",Seconds]]];
    self.luzhishijian.text = _videoTime;
}
